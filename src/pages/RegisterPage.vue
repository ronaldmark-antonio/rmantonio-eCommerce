<script setup>
  ...
  watch([firstName, lastName, email, mobileNum, password, confirmPass], (currValue, oldValue) => {
      ...
      <div class="col-md-6 border rounded-3 mx-auto p-5">
        <form v-on:submit="handleSubmit">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="lName" placeholder="Enter your last name..." v-model="lastName" required />
          </div>
          <div class="mb-3">
            <label for="mobile" class="form-label">Mobile Number</label>
            <input type="text" class="form-control" id="mobile" placeholder="Enter your mobile number..." v-model="mobileNum" required />
          </div>
          ...
          <div class="mb-3">
            ...
            placeholder="Confirm your password..." v-model="confirmPass" required />
          </div>
          <div>
            <button type="submit" class="btn btn-primary btn-block" v-if="submitEnabled">Submit</button>
